...
SECRET_KEY = '-bym&^0w7qre*p1f&1zgt#qc4%vwsdih-6hj4rc+fr$b=zw__9'
...
# psql -U django -d yunwei -h 127.0.0.1 -p 5432
DATABASES = {
    'default': {
...
# media use to put somethings user upload
